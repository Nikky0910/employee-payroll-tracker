...
const collectEmployees = function () {
  ...
  do {
    ...
    isContinue = confirm("Do you want to continue or to cancel?");
...
const displayAverageSalary = function (employeesArray) {
  ...
  for (let i=0; i< totalEmployees; i++) {
    let objectSalary= employeesArray[i].salary;
    totalSalary= objectSalary+ totalSalary;
  }
...
const getRandomEmployee = function (employeesArray) {
  ...
  console.log(`Congratulations to ${employee.firstName},our random drawing winner!`)
  return employee;
